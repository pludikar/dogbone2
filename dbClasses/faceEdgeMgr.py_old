...
class DbGroup:
    ...
    def __init__(self, faceEntity:adsk.fusion.BRepFace, parent: DbGroups, dbParams: DbParams):
        ...
        self.groups.dbOccurrences.add(faceEntity.entityToken)
...
#TODO
        return self.groupHash == other.groupHash

    def addFaces(self, face: adsk.fusion.BRepFace):
    ...
    def addFace(self, face: adsk.fusion.BRepFace, parentFaces):
        #==============================================================================
        ...
        if faces:
            faceObject = self.registeredFaces[calcOccHash(face)][face.entityToken]
    ...
    def addEdge(self, edge):
        edgeHash = edge.entityToken
        for edgeList in self.registeredEdges.values():
            if edge.entityToken in edgeList:
